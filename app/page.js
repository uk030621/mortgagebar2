...
const handleBarClick = (index) => {
  ...
  return (
    <div>
      <a className='hyperlink1' href="https://mortgagebar1.vercel.app/" onClick="window.close()" rel="noopener noreferrer"style={{ color: 'rgba(227, 72, 72, 0.9)' }}>Link to Advisor Mortgage Tracking</a>
    
      <h1 className='heading'>COAST Financial Solutions: <span className='advisor'>Advisor <span className='advisor-type'>Protection</span> Tracking</span></h1>
